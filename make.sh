...
if [[ "${DOC}" == "1" ]]; then
  if [[ -x "$(command -v help2man)" ]]; then
    ...
    help2man -n "terminal-based spell checking using ChatGPT" -N -o nspell-gpt.1 ./nspell-gpt && ${SED} "s/\.\\\\\" DO NOT MODIFY THIS FILE\!  It was generated by help2man.*/\.\\\\\" DO NOT MODIFY THIS FILE\!  It was generated by help2man./g" nspell-gpt.1 || exiterr "doc failed, exiting."
  fi
fi
